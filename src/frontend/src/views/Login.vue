<template>
  ...
  <div class="bg-violet-700 w-1/3 h-64 rounded-xl flex flex-col container mx-auto mt-24">
    <div class="mx-auto mt-2 text-white basis-1/3 font-medium text-lg mt-4">Вход</div>
    <div class="mx-auto basis-1/3">
      <input type="text"
             placeholder="Логин"
             class="focus:outline-none focus:ring focus:border-cyan-400 rounded bg-white h-10 w-64 indent-2"
             v-model="username" />
    </div>
    <div class="mx-auto basis-1/3">
      <input type="text"
    ...
    <div class="mx-auto basis-1/3">
      <button type="button" class="transition duration-150 ease-in-out w-auto h-9 rounded
        ...
        <div class="flex flex-row">
          <div class="font-sans ml-2.5 text-sm text-violet-700 font-medium ">Войти</div>
          <div class="">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#6D28D9" class="w-5 h-5">
