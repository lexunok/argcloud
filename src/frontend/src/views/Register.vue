<template>
  ...
  <div class="bg-violet-700 w-1/3 h-[28rem] rounded-xl flex flex-col container mx-auto mt-12">
    ...
    <div class="mx-auto basis-1/3 flex flex-col">
      <div class="mx-auto">
        <input type="text"
               id="register-input"
               placeholder="Логин"
    ...
    <div class="mx-auto basis-1/3 mt-3">
